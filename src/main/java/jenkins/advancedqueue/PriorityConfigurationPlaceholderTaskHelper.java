    ...
    PriorityConfigurationCallback getPriority(
        ...
        if (ownerTask instanceof Job<?, ?> job) {
            ...
            if (itemInfo != null) {
                ...
                if (PrioritySorterConfiguration.get() != null
                        && PrioritySorterConfiguration.get().getStrategy() != null) {
                    priorityCallback.setPrioritySelection(
            ...
            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.log(
                        Level.FINE,
                        "Cannot determine priority of the Pipeline Placeholder Task {0}. Its owner task {1} is not a Job (type is {2}). "
