...
public class ConfigurationAsCodeTest {
	...
	public void PrioritySorterConfiguration() throws ConfiguratorException {
		ConfigurationAsCode.get().configure(ConfigurationAsCodeTest.class.getResource("ConfigurationAsCodeTest/PrioritySorterConfiguration.yaml").toString());
	...
	public void PriorityConfiguration() throws ConfiguratorException {
		ConfigurationAsCode.get().configure(ConfigurationAsCodeTest.class.getResource("ConfigurationAsCodeTest/PriorityConfiguration.yaml").toString());
	...
	private static <T extends PriorityStrategy> T assertStrategy(Class<T> strategyClass, JobGroup jobGroup, int index) {
		assertThat(jobGroup.getPriorityStrategies().get(index).getPriorityStrategy().getClass(), is(strategyClass));
		try {
			return strategyClass.cast(jobGroup.getPriorityStrategies().get(index).getPriorityStrategy());
