...
public class WFQStrategyTest {
    ...
    public void testGetWeightToUse() {
        ...
        Assert.assertEquals(
                1.00000F + 2 * FQBaseStrategy.MIN_STEP_SIZE, new WFQStrategy().getWeightToUse(2, 1.00000F), 0F);
        Assert.assertEquals(
                1.00001F + 2 * FQBaseStrategy.MIN_STEP_SIZE, new WFQStrategy().getWeightToUse(2, 1.00001F), 0F);
    }
}
